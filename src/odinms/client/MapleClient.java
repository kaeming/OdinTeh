...
import odinms.tools.IPAddressTool;
import odinms.tools.MapleAESOFB;
...
public class MapleClient {
	...
	public static String getChannelServerIPFromSubnet(String clientIPAddress, int channel) {
		...
		if(subnetInfo.contains("odinms.net.login.subnetcount")) {
			int subnetCount = Integer.parseInt(subnetInfo.getProperty("odinms.net.login.subnetcount"));
			for(int i = 0; i < subnetCount; i++) {
				String[] connectionInfo = subnetInfo.getProperty("odinms.net.login.subnet." + i).split(":");
