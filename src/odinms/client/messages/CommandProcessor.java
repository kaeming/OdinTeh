...
package odinms.client.messages;
...
import odinms.client.messages.commands.HelpCommand;
...
import odinms.tools.ClassFinder;
import odinms.tools.MockIOSession;
...
public class CommandProcessor implements CommandProcessorMBean {	
	...
	public static void registerMBean() {
		...
		try {
			mBeanServer.registerMBean(instance, new ObjectName("odinms.client.messages:name=CommandProcessor"));
		} catch (Exception e) {
	...
	/* (non-Javadoc)
	 * @see odinms.client.messages.CommandProcessorMBean#processCommandJMX(int, int, java.lang.String)
	 */
	...
	public void reloadCommands() {
		...
		try {
			...
			String[] classes = classFinder.listClasses("odinms.client.messages.commands", true);
	...
	/* (non-Javadoc)
	 * @see odinms.client.messages.CommandProcessorMBean#processCommandInstance(odinms.client.MapleClient, java.lang.String)
	 */
