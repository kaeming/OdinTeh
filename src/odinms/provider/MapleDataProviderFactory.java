...
package odinms.provider;

import java.io.File;
import java.io.IOException;

import odinms.provider.wz.WZFile;
import odinms.provider.xmlwz.XMLWZFile;

public class MapleDataProviderFactory {
	private final static String wzPath = System.getProperty("odinms.wzpath");
