...
import odinms.provider.wz.MapleDataType;
...
public class MapleLifeFactory {
	...
	private static MapleDataProvider data = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("odinms.wzpath") + "/Mob.wz"));
	private static MapleDataProvider stringDataWZ = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("odinms.wzpath") + "/String.wz"));
