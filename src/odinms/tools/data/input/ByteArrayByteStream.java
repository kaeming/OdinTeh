...
package odinms.tools.data.input;
...
public class ByteArrayByteStream implements SeekableInputStreamBytestream {
	 ...
	 * @see odinms.tools.data.input.SeekableInputStreamBytestream#getPosition()
	 */
	@Override
	 ...
	 * @see odinms.tools.data.input.SeekableInputStreamBytestream#seek(long)
	 */
	@Override
	 ...
	 * @see odinms.tools.data.input.ByteInputStream#getBytesRead()
	 */
	@Override
	 ...
	 * @see odinms.tools.data.input.ByteInputStream#readByte()
	 */
	@Override
	public int readByte() {
		bytesRead++;
	 ...
	 * @see odinms.tools.data.input.ByteInputStream#available()
	 */
	@Override
